function [slope_deterministic,slope] = calculateSlope_PFPF_EDH(z,edh_linearization,xp,mu_0,P,R,zeta,ps,lambda)
...
xp_linearization = edh_linearization;
...
b = (eye(dim)+2*lambda*A)...
        ...
        *(R\zc)+A*mu_0);
%%
slope = A*xp + repmat(b,1,N);
slope_deterministic = A*edh_linearization + b;
end