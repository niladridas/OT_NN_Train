function vg = GMMparticleFlow(vg,ps,z_current)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
log_jacobian_det_sum = zeros(1,ps.setup.nParticle);
...
vg = correctionAndCalculateWeights(vg,ps,z_current,log_jacobian_det_sum);
end