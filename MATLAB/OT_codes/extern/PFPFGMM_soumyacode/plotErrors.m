...
error_5percentile_per_alg = zeros(ps.setup.nTrial,length(ps.setup.algs_executed));
error_25percentile_per_alg = zeros(ps.setup.nTrial,length(ps.setup.algs_executed));
error_50percentile_per_alg = zeros(ps.setup.nTrial,length(ps.setup.algs_executed));
error_75percentile_per_alg = zeros(ps.setup.nTrial,length(ps.setup.algs_executed));
error_95percentile_per_alg = zeros(ps.setup.nTrial,length(ps.setup.algs_executed));
...
%         plotOneAlgorithmsPerformance(output,ps,plot_settings,alg_ix);
    [error_per_trial_per_alg(:,alg_ix),error_5percentile_per_alg(:,alg_ix),...
     error_25percentile_per_alg(:,alg_ix),error_50percentile_per_alg(:,alg_ix),...
    error_75percentile_per_alg(:,alg_ix),error_95percentile_per_alg(:,alg_ix),ESS_per_trial_per_alg(:,alg_ix),...
    execution_time_per_alg(alg_ix)] = ...
    plotOneAlgorithmsPerformance(output,ps,plot_settings,alg_ix);
end
