function [Otfilterdata] = OTsinkfilterandprop(initsamples,obs,simparams,filterparams)
    ...
    for i = 1:Nt
        ...
        %% OT-Sinkhorn 
        sinkparams.lambda = 5;sinkparams.stoppingCriterion=[];sinkparams.p_norm=[];
        sinkparams.tolerance = [];sinkparams.maxIter = [];     
        tic; OT_samplesX = OTsink(prior_samples(:,:,i)',nSamp,nx,sinkparams,W0,W_post); toc;
        run_time(1,i) = toc;
